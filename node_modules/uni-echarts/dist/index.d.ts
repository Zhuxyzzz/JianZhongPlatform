...
import { SetOptionOpts, init, ECElementEvent, ElementEvent } from 'echarts/core';
...
export { type AutoResize, type CanvasContext, type CanvasNode, type CanvasRect, type ChartOption, type ChartOptionInjection, type ChartTheme, type ChartThemeInjection, ECHARTS_KEY, type EChartsType, type Emitter, type EventHandlerList, type EventHandlerMap, type EventType, type GetTouchFuc, type Handler, INIT_OPTIONS_KEY, type InitOptions, type InitOptionsInjection, type InitParameters, LOADING_OPTIONS_KEY, type LoadingOptions, type LoadingOptionsInjection, type MinifyEcharts, type NormalizedTouch, OPTION_KEY, Platform, type PublicApi, THEME_KEY, UPDATE_OPTIONS_KEY, UniCanvas, type UniEchartsEmits, type UniEchartsInst, type UniEchartsProps, UniImage, type UpdateOptions, type UpdateOptionsInjection, type VueThis, type WildCardEventHandlerList, type WildcardHandler, type ZRenderHandler, type ZRenderType, canIUseCanvas2d, compareVersion, defaultTo, getAppBaseInfo, getDeviceInfo, getEchartsOptionKey, getIsPc, getPlatform, getVersion, getWindowInfo, isApp, isAppAndroid, isAppHarmony, isAppIos, isEmpty, isMp, isMp360, isMpAlipay, isMpBaidu, isMpHarmony, isMpJd, isMpKuaishou, isMpLark, isMpQq, isMpToutiao, isMpWeixin, isMpXhs, isOtherPlatform, isQuickappWebview, isQuickappWebviewHuawei, isQuickappWebviewUnion, isWeb, lowerFirst, mitt, platform, provideEcharts, provideEchartsInitOptions, provideEchartsLoadingOptions, provideEchartsOption, provideEchartsTheme, provideEchartsUpdateOptions, querySelect, setupEchartsCanvas, sleep, upperFirst, useAutoresize, useEcharts, useEchartsInitOptions, useEchartsMouseWheel, useEchartsOption, useEchartsTheme, useEchartsTouch, useEchartsUpdateOptions, useLoading, usePublicApi, useUid, useVueThis };
